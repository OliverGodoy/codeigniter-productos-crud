<h1 class="h3 mb-0">Crear tarifa</h1>
...
<?= form_open('tarifas/crear' , ['class' => 'bg-white p-4 rounded shadow-sm']) ?>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="number" step="0.01" min="0" name="precio_por_metro_cubico" id="precio_por_metro_cubico"
                   class="form-control" value="<?= set_value('precio_por_metro_cubico') ?>" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="number" min="0" name="consumo_minimo" id="consumo_minimo" class="form-control"
                   value="<?= set_value('consumo_minimo', 0) ?>" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-check form-switch">
                <?= form_checkbox([
                    ...
                    'value' => 1,
                    'checked' => set_checkbox('activa', 1, true),
                ]) ?>
